    ...
    <div className="w-full px-10 relative">
      ...
      <div className="px-10 pb-12 pt-10 relative z-10">
        <div className="flex gap-8 items-start">
          {/* Account Section */}
          <div className="border border-[#e9eaeb] dark:border-[#2a2a2a] box-border flex flex-col gap-6 items-start p-9 relative rounded-[12px] shrink-0 bg-white dark:bg-[#1f1f1f]">
            <div className="flex gap-2.5 items-center relative shrink-0">
              <UserIcon className="w-6 h-6" stroke="#181d27" />
              <p className="font-medium leading-[30px] text-[#181d27] dark:text-[#FDFDFD] text-xl">Account</p>
            </div>
            <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
              ...
              <div className="flex gap-4 items-start">
                <button
                  ...
                  className="bg-white dark:bg-[#1f1f1f] border border-[#e9eaeb] dark:border-[#2a2a2a] rounded-lg flex items-center justify-center px-[14px] py-2 hover:opacity-80 transition-opacity"
                >
                  <p className="font-medium leading-5 text-[#414651] dark:text-[#e0e0e0] text-sm">Log Out</p>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="border border-[#e9eaeb] dark:border-[#2a2a2a] box-border flex flex-col gap-6 items-start p-9 relative rounded-[12px] shrink-0 bg-white dark:bg-[#1f1f1f]">
            <div className="flex gap-2.5 items-center relative shrink-0">
              ...
              <p className="font-medium leading-[30px] text-[#181d27] dark:text-[#FDFDFD] text-xl">Notifications</p>
            </div>
            <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
              ...
              <div className="flex flex-col gap-2 items-start justify-center relative shrink-0 w-full">
                <p className="font-medium leading-6 text-[#535862] dark:text-[#A4A7AE] text-base">Pause Notifications for</p>
                  ...
                  <div className="flex gap-6 items-center relative shrink-0">
                    <div className="flex flex-col items-start relative shrink-0 w-[120px]">
                      <input
                        ...
                        className="bg-white dark:bg-[#1f1f1f] border border-[#d5d7da] dark:border-[#2a2a2a] rounded-[8px] w-full px-[14px] py-[10px] font-normal leading-6 text-base tracking-[-0.32px] text-[#717680] dark:text-[#A4A7AE] outline-none hover:border-[#1570ef] dark:hover:border-[#4A9EFF] focus:border-[#1570ef] dark:focus:border-[#4A9EFF] transition-colors"
                        placeholder="0"
                      />
                    </div>
                    <p className="font-normal leading-6 text-base text-black dark:text-[#FDFDFD] tracking-[-0.32px] w-[44px]">
                      Hours
                    </p>
                  </div>
                  <button
                    ...
                    className="bg-white dark:bg-[#1f1f1f] border border-[#e9eaeb] dark:border-[#2a2a2a] rounded-lg flex items-center justify-center px-[14px] py-2 hover:opacity-80 transition-opacity"
                  >
                    <p className="font-medium leading-5 text-[#414651] dark:text-[#e0e0e0] text-sm">Submit</p>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="border border-[#e9eaeb] dark:border-[#2a2a2a] box-border flex flex-col gap-6 items-start p-9 relative rounded-[12px] shrink-0 bg-white dark:bg-[#1f1f1f]">
            <div className="flex gap-2.5 items-center relative shrink-0">
              ...
              <p className="font-medium leading-[30px] text-[#181d27] dark:text-[#FDFDFD] text-xl">Preferences</p>
            </div>
            <div className="flex flex-col gap-2.5 items-start relative shrink-0 w-full">
              <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
                <p className="font-medium leading-6 text-[#535862] dark:text-[#A4A7AE] text-base">Light/Dark Mode</p>
              </div>
              <ButtonGroup
