  ...
  return (
    <div className="w-full px-10 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute bg-gradient-to-b blur-[100px] filter from-transparent opacity-10 to-[var(--color-primary)] h-[559px] left-[227px] top-[-76px] w-[394px]" />
      </div>
      ...
      <div className="px-10 pb-12 pt-10 relative z-10">
        <div className="flex gap-8 items-start">
          {/* Account Section */}
          <div className="border border-theme-primary bg-theme-card box-border flex flex-col gap-6 items-start p-9 relative rounded-[12px] shrink-0">
            <div className="flex gap-2.5 items-center relative shrink-0">
              <UserIcon className="w-6 h-6 text-theme-primary" />
              <p className="font-medium leading-[30px] text-theme-primary text-xl">Account</p>
            </div>
            <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
              ...
              <div className="flex gap-4 items-start">
                <button
                  ...
                  className="bg-theme-card border border-theme-primary rounded-lg flex items-center justify-center px-[14px] py-2 hover:bg-theme-hover transition-opacity cursor-pointer"
                >
                  <p className="font-medium leading-5 text-theme-secondary text-sm">Log Out</p>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="border border-theme-primary bg-theme-card box-border flex flex-col gap-6 items-start p-9 relative rounded-[12px] shrink-0">
            <div className="flex gap-2.5 items-center relative shrink-0">
              ...
              <p className="font-medium leading-[30px] text-theme-primary text-xl">Notifications</p>
            </div>
            <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
              ...
              <div className="flex flex-col gap-2 items-start justify-center relative shrink-0 w-full">
                <p className="font-medium leading-6 text-theme-secondary text-base">Pause Notifications for</p>
                  ...
                  <div className="flex gap-6 items-center relative shrink-0">
                    <div className="flex flex-col items-start relative shrink-0 w-[120px]">
                      <input
                        ...
                        className="bg-theme-input border border-theme-secondary rounded-[8px] w-full px-[14px] py-[10px] font-normal leading-6 text-base tracking-[-0.32px] text-theme-tertiary outline-none hover:border-[var(--color-primary)] focus:border-[var(--color-primary)] transition-colors"
                        placeholder="0"
                      />
                    </div>
                    <p className="font-normal leading-6 text-base text-theme-primary tracking-[-0.32px] w-[44px]">
                      Hours
                    </p>
                  </div>
                  <button
                    ...
                    className="bg-theme-card border border-theme-primary rounded-lg flex items-center justify-center px-[14px] py-2 hover:bg-theme-hover transition-opacity cursor-pointer"
                  >
                    <p className="font-medium leading-5 text-theme-secondary text-sm">Submit</p>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="border border-theme-primary bg-theme-card box-border flex flex-col gap-6 items-start p-9 relative rounded-[12px] shrink-0">
            <div className="flex gap-2.5 items-center relative shrink-0">
              <SlidersIcon className="w-6 h-6 text-theme-primary" />
              <p className="font-medium leading-[30px] text-theme-primary text-xl">Preferences</p>
            </div>
            <div className="flex flex-col gap-2.5 items-start relative shrink-0 w-full">
              <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
                <p className="font-medium leading-6 text-theme-secondary text-base">Light/Dark Mode</p>
              </div>
              <ButtonGroup
